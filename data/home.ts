...
export const whyUs = [
  {
    ...
    desc: "Carefully selected products with exceptional freshness and taste — sourced from the finest origins.",
    icon: "quality",
  },
  {
    title: "Elegant Packaging",
    desc: "Gift-ready magnetic boxes, ribbons, and custom branding that speak before the product does.",
    icon: "packaging",
  },
  {
...
export const processSteps = [
  ...
  },
  {
    ...
    desc: "Browse curated collections or work with our team to build a fully bespoke assortment.",
  },
  {
    step: "03",
    title: "Customization",
    desc: "Add your logo, choose packaging, include handwritten cards, and select ribbon colours.",
  },
  {
    step: "04",
    title: "Production",
  ...
  },
  {
    step: "05",
    title: "Quality Check",
    desc: "A dedicated QC pass ensures every hamper meets our premium standard before dispatch.",
  },
  {
    step: "06",
    title: "Delivery",
...
export const blogPosts = [
  {
    ...
    excerpt: "From personalisation to premium packaging, discover how the best brands elevate their gifting strategy.",
    category: "Corporate Gifting",
    date: "June 12, 2025",
    href: "/blog/corporate-gifting-guide",
    img: woodenBoxNuts,
  },
  {
    title: "7 Health Benefits of Premium Dry Fruits You Should Know",
    excerpt: "Beyond gifting, premium dry fruits are nutritional powerhouses. Here is what makes each nut remarkable.",
    category: "Health & Wellness",
    date: "May 28, 2025",
    href: "/blog/health-benefits-dry-fruits",
    img: closeUpNuts,
  },
  {
    title: "How to Choose the Perfect Wedding Hamper for Your Guests",
    excerpt: "A guide to curating luxury wedding favours that reflect your style and delight every guest.",
    category: "Wedding Gifting",
    date: "May 10, 2025",
    href: "/blog/wedding-hamper-guide",
    img: topViewDiffNuts,
  },
];

export const galleryPreviewImages = [
  { src: woodenBoxNuts, alt: "Premium dry fruits in a luxury wooden gift box" },
  { src: topViewPistachios, alt: "Artisanal pistachio and nut arrangement" },
  { src: sweetiesDesk, alt: "Curated chocolate and confectionery desk arrangement" },
  { src: driedFruitsCounter, alt: "Premium dry fruits displayed at gifting counter" },
  { src: nutsSetTable, alt: "Assorted premium nuts in presentation bowls" },
  { src: topViewDriedFruits, alt: "Top view of premium dry fruits and chocolates" },
];
