  ...
  const categories = [
    {
      ...
      forText: "Employee teams, staff festive hampers, HR rewards & large staff groups.",
      highlights: [
        "Budget-friendly options from ₹400",
        "Uniform premium packaging",
        "Individual name tags & greeting cards",
        "Bulk office floor delivery in Pune",
      ],
    ...
    },
    {
      ...
      forText: "High-value clients, vendors, dealers, channel partners & business associates.",
      highlights: [
        "Custom metallic foil company logo",
        "Exquisite dry fruits & chocolate curation",
        "Curated gourmet assortments",
        "Pan-India multi-location dispatch",
      ],
      ctaText: "EXPLORE CLIENT GIFTS",
      href: "/corporate-gifting#client",
      badge: "High Impact & Retention",
    },
    {
      num: "03",
      title: "Premium Corporate Gifting",
      icon: <FiStar className="h-6 w-6 text-reef-gold" />,
      forText: "Senior leadership, CXOs, VIP clients, board members & keynote delegates.",
      highlights: [
        "Handcrafted wooden & leatherette boxes",
        "Jumbo nuts, gold leaf artisanal sweets",
        "Custom branded executive message",
        "White-glove priority concierge delivery",
      ],
      ctaText: "VIEW PREMIUM GIFTS",
      href: "/corporate-gifting#premium",
      badge: "Executive & VIP Tiers",
    },
  ];
