  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-[#111111] px-8 py-16 text-center sm:px-14 sm:py-24">
        ...
        />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-reef-gold/40 to-transparent" aria-hidden />
        <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-reef-gold/40 to-transparent" aria-hidden />
        ...
        <div className="relative">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border-2 border-white/30 bg-transparent px-8 py-4 text-sm font-bold text-white shadow-md transition duration-200 hover:-translate-y-0.5 hover:border-white hover:bg-white/10"
            >
          ...
          <p className="mt-8 flex items-center justify-center gap-2 text-xs text-white/40">
            <svg className="h-4 w-4 text-reef-gold/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
            ...
            Shop F14, Streets of Europe Mall, Maan Road near Infosys Circle, Hinjewadi Phase I, Pune 411057
          </p>
        </div>
      </div>
    </section>
