...
| `phone_call_click` | Clicked phone link (+91 9890609611) | Local / B2B | P1 (Macro) |
| `whatsapp_click` | Clicked WhatsApp button (+91 9890609611) | Local / B2B | P1 (Macro) |
...
*References: 00_Analytics_Master.md, 02_GTM_Architecture.md, 11_BigQuery.md, 20_Developer_Implementation.md*
