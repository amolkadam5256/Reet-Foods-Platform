...
| `phone_call_click` | Lead | Click `tel:+919890609611` | `phone_number`, `click_location`, `page_url` | **YES** | P1 |
...
*References: 00_Analytics_Master.md, 04_Enhanced_Ecommerce.md, 20_Developer_Implementation.md*
