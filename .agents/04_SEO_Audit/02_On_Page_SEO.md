...
| WhatsApp link | `wa.me/919876543210` | **WRONG NUMBER** — placeholder | Fix to `919890609611` |
| FAQSchema | ✅ Present | ✅ | ✅ |
...
export const metadata = constructMetadata({
  ...
  description: "Common questions about corporate gift orders, custom logo boxes, MOQ, PAN-India delivery, OEM services and festive hamper customization at Reet Foods Pune.",
  canonical: "/faq",
});
...
export const metadata = constructMetadata({
  ...
  description: "Contact Reet Foods & Gifting in Pune for premium dry fruit boxes, chocolate hampers, custom corporate gifts and bulk orders. Get a quote within 2 hours.",
  canonical: "/contact",
});
```
