...
| `telephone` | `+91-9876543210` | **PLACEHOLDER — WRONG** | Change to `+91-9890609611` |
...
| `telephone` | `+91-9876543210` | **WRONG NUMBER** | Change to `+91-9890609611` |
...
"telephone": "+91-9890609611",  // correct number
"foundingDate": "2016",
...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://reetfoodsngiftings.com/products?q={search_term_string}",
        "query-input": "required name=search_term_string"
      }
    })
  }}
