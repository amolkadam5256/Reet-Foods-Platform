...
| Item          | Value                               |
| ------------- | ----------------------------------- |
| Project Name  | Reet Foods & Gifting                |
...
Manual / Next.js Script Implementation

Added inside `app/layout.tsx` via `next/script`.
...
- Actionable data to improve the Reet Foods & Gifting user experience
