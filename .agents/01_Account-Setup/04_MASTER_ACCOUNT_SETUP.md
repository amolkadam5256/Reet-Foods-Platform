...
- **Google Business Profile (GBP):** Verified business profile under *Reet Foods and Giftings* (Hinjewadi Phase I, Pune).
...
|----------|----------------------|---------------------|-----------------------|
| **WhatsApp** | `https://wa.me/919890609611` | Active Channel | Direct corporate orders & inquiries |
