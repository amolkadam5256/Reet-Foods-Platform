...
| **EXP-05** | City Page Hero | Standard Headline | Hinjewadi Proximity: *"Store near Infosys Circle, Hinjewadi"* | Page Conversion % | Hyper-local trust increases conversions |
| **EXP-06** | Trust Badges | Footer Trust Icons | Trust Pills Under H1: *"FSSAI Certified: 21526079003816 | GST Billing"* | Bounce Rate | Immediate compliance proof reduces bounce |
| **EXP-07** | Exit Popup | Generic "Sign Up for Updates" | Exit Modal: *"Need 50+ Boxes? Get Free Custom Logo Branding"* | Lead Capture % | Relevant B2B offer captures exit traffic |
...
| **EXP-09** | Cart Drawer | Plain Checkout Button | Free Delivery Progress Bar: *"Add ₹500 for Free Pune Delivery"* | AOV (Average Order Value) | Gamifying free shipping threshold increases AOV |
...
*References: 05_Landing_Page_CRO.md, 08_CTA_Strategy.md, 19_KPI_Dashboard.md*
