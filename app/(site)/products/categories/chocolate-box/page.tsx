...
const category = productCategories.find((c) => c.slug === "chocolate-gift-box");

export default function ChocolateBoxPage() {
  if (!category) return null;
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 space-y-6">
      <h1 className="text-3xl font-serif text-reef-burgundy">Chocolate Boxes</h1>
